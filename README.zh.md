...
从 [codeberg Releases](https://codeberg.org/application/govm/releases) 下载最新版本，并添加到 PATH。
...
如有问题和功能请求，请访问 [codefloe Issues](https://codeberg.org/application/govm/issues) 页面。
